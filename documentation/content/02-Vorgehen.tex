...
Bei der Entwicklung wurden von Beginn an Unittests verwendet um die Funktionsweise der einzelnen Komponenten zu überprüfen.
...
sind alle Klassen, welche nicht zur Ableitung gedacht sind \textit{final}. 
Bei allen Klassen wurde die Sichtbarkeit der Felder minimiert, sowie auf innere Klassen 
verzichtet, um die Sichbarkeitseinschränkung nicht zu umgehen. Wenn immer möglich, wurden die 
Konstruktoren \textit{private} deklariert, und Factory-Methoden implementiert.
\newline
